...
```
           theme = sjPlot::theme_sjplot() + 
                   theme(plot.title = element_blank(),  # Ensure the title is removed
                         axis.title.x = element_text(size = 26, face = "bold"), # Customize x axis title appearance
                         axis.title.y = element_text(size = 12, face = "bold"), # Customize y axis title appearance
