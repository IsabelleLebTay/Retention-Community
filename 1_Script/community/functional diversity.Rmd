...
for (bird in species_list) {
  ...
  write.csv(edge_top, glue("2_Outputs/Single species/Dredge tables/R2 values/{bird}_edge_R2.csv"))
  write.csv(area_top, glue("2_Outputs/Single species/Dredge tables/R2 values/{bird}_area_R2.csv"))
}
```
...
# Residuals not behaving as expected without the re. Fixed by adding the location re.
