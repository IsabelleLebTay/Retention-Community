...
# Best model so far
Func_diversity_glm0b <- glmmTMB(FEve ~ RETN_m2,
                        data = FuncDiv_Covs,
                        family = gaussian)
...
# Top model
Func_diversity_glm1b <- glmmTMB(FEve ~ RETN_m2 + Year_since_logging,
                        data = FuncDiv_Covs,
                        family = gaussian)
AIC(Func_diversity_glm1b) # -921.6
summary(Func_diversity_glm1b)
...
TEWA <- glmmTMB(TEWA ~ poly(Year_since_logging2) + Year_since_logging + RETN_m2 + Dist_near_forest,
                data = Abund_Covs,
                family = poisson)
summary(TEWA)
